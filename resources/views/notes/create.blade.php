<x-layout title="notes">
    ...
    <x-slot:heading> Create note </x-slot:heading>

    <form method="POST" action="/notes" class="max-w-xl mx-auto">

        <!-- Note Title -->
        <div class="sm:col-span-4">
            <label for="title" class="block text-sm/6 font-medium text-white">Title</label>
            <div
                class="flex items-center rounded-md bg-white/5 pl-3 outline-1 -outline-offset-1 outline-white/10 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-purple-500 mt-2 @error('title') border border-red-500 @enderror">
        ...
        <div class="col-span-full mt-6">
            ...
            <div class="mt-2">
                <textarea id="description" name="description" rows="3"
                    ...
                    placeholder="Complete the remaining form inputs">{{ old('description') }}</textarea>
            </div>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-3">
            ...
            <button type="submit"
                class="rounded-md bg-indigo-500 px-5 py-2 text-sm font-semibold text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Save</button>
        </div>
